...
const translations = {
  uz: {
    ...
    greeting:
      "Assalomu alaykum! Men Erkinov Bexruz - matematika o'qituvchisiman.",
    intro_text:
      "Maktabda matematika fanidan dars beraman va o'quvchilarimni muvaffaqiyatga erishish uchun tayyorlashga intilaman.",
    ...
    service1_desc:
      "Har bir o'quvchining shaxsiy ehtiyojlariga moslashtirilgan individual darslar",
    ...
    footer_about_text:
      "Matematika o'qituvchisi sifatida men o'quvchilarning bilimlarini oshirishga va ularning kelajakdagi muvaffaqiyatlariga hissa qo'shishga intilyapman.",
    ...
    newsletter_text:
      "Yangi darslar va maxsus takliflar haqida birinchilardan bo'lib xabardor bo'ling",
  ...
  en: {
    ...
    intro_text:
      "I teach mathematics at school and strive to prepare my students for success.",
    motto: '"Every student can find their potential!"',
    contact_btn: "Contact me",
    about_title: "About me",
    about_subtitle: "About my education and experience",
    about_text:
      "Hello! I am Erkinov Bekhruz, a mathematics teacher with 2 years of experience. I am dedicated to my work and strive to enhance my students' knowledge through mathematics. For me, teaching is not just about giving lessons, but helping students become a great source of knowledge. Mathematics, in my opinion, is not limited to calculations but requires problem-solving, development of logical thinking, and creative approaches. In teaching this subject, I always try to take into account the personal needs and interests of students.",
    services_title: "My services",
    services_subtitle: "Services provided for students",
    service1_title: "Individual lessons",
    service1_desc:
      "Individual lessons tailored to each student's personal needs",
    service2_title: "Group lessons",
    service2_desc: "Effective teaching in small groups",
    service3_title: "Online lessons",
    service3_desc:
      "Opportunity to study at a convenient time through distance learning",
    service4_title: "Olympiad preparation",
    service4_desc: "Special preparation for Olympiads",
    footer_about_title: "About me",
    footer_about_text:
      "As a mathematics teacher, I am committed to enhancing students' knowledge and contributing to their future success.",
    ...
    newsletter_text:
      "Be the first to know about new lessons and special offers",
  ...
  ru: {
    ...
    newsletter_text:
      "Узнавайте первыми о новых уроках и специальных предложениях",
...
function updateThemeIcon(theme) {
  themeIcon.className =
    theme === "dark" ? "bx bx-moon text-2xl" : "bx bx-sun text-2xl";
}
...
document.getElementById('mobileLanguageSelector').addEventListener('change', (event) => {
